      ...
      <div className="profile-content">
          ...
          <div className="picture-div">
            {user.profilePic === "K" ? (
              <Skeleton
                ...
                width={246}
                height={246}
                style={{ backgroundColor: "rgba(130, 130, 130, 0.72)" }}
              />
            ) : (
              ""
            )}
        ...
        <div className="profile-content-left">
          ...
          <div
            ...
            style={{ display: user.message === "not the user logged" ? "none" : "" }}
          >
            <button
          ...
          {pass === 0 ? (
            <EditInfo data={{ visible, setvisible }} data1={{ user, setUser }} />
          ) : (
            <EditPass data={{ visible, setvisible }} data1={{ user, setUser }} />
          )}
        </div>
      </div>

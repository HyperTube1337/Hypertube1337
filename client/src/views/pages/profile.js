      ...
      <div className="profile-content">
        <div className="profile-content-right">
          <div className="picture-div">
            {user.profilePic === "K" ? <Skeleton variant="circle" width={246} height={246} style={{ backgroundColor: "rgba(130, 130, 130, 0.72)" }} /> : ""}
            {user.profilePic && user.profilePic !== "K" ? <img className="Inpic" src={user.profilePic} alt={user.profilePic} key={user.profilePic} /> : ""}
        ...
        <div className="profile-content-left">
          ...
          {pass === 0 ? <EditInfo data={{ visible, setvisible }} data1={{ user, setUser }} /> : <EditPass data={{ visible, setvisible }} data1={{ user, setUser }} />}
        </div>
      </div>

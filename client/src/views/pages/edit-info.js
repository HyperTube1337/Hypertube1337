...
export default function EditInfo(props) {
	...
	useEffect(() => {
		...
		if (
			(props.data1.user.firstname &&
				!isName(props.data1.user.firstname) &&
		...
		if (
			(props.data1.user.lastname &&
				!isName(props.data1.user.lastname) &&
		...
		if (
			(props.data1.user.username &&
				!isUsername(props.data1.user.username) &&
		...
		if (
			...
			!isEmail(props.data1.user.email) &&
			props.data1.user.email.length < 24
		) {
	...
	return (
		<div
			className="inputs inputs-profile"
			data-aos="fade-up"
		...
		>
			...
			<div
				...
				style={{
					width: "97%",
					display: props.data.visible === 0 ? "none" : "inline",
				}}
			>
				<button
					className="register-button inpt-profile"
					onClick={() => handelEdit()}
				>

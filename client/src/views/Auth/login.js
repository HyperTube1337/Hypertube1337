		...
		>
			...
			>
				...
				<div className="inputs">
					...
					<button
						className="passport-button Intra"
						onClick={() =>
							(window.location = "http://localhost:3001/auth/42")
						}
					>
						<FormattedMessage id="passport" />
						&nbsp;Intra{" "}
					...
					<FormattedMessage id="Username">
						{(text) => (
							<input
								...
								value={user.username}
								style={{
									borderBottomColor: userErrors.errusername,
								}}
								onChange={(e) => {
					...
					<FormattedMessage id="Password">
						{(text) => (
							<input
								...
								value={user.password}
								style={{
									borderBottomColor: userErrors.errpassword,
								}}
								onChange={(e) => {
